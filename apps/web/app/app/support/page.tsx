  ...
  return (
    <>
      ...
      <main className="px-5 pb-32 pt-1 flex flex-col gap-4">
        <section className="rounded-3xl bg-white border border-parkingrabbit-border p-5 flex flex-col gap-3">
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-[12.5px] text-parkingrabbit-muted mt-1 leading-snug">
          ...
          <a
            href={MAILTO}
            className="mt-1 rounded-2xl bg-parkingrabbit-primary text-white font-bold text-center py-3.5 hover:bg-parkingrabbit-primary-600 transition shadow-lg shadow-parkingrabbit-primary/30 inline-flex items-center justify-center gap-2"
          >
        ...
        <section className="rounded-3xl bg-parkingrabbit-bg/50 border border-dashed border-parkingrabbit-border p-5 flex flex-col gap-3 min-h-[200px]">
          <p className="text-[10.5px] font-bold uppercase tracking-wide text-parkingrabbit-muted">
            Conversation
          </p>
          <div className="self-start max-w-[85%] rounded-2xl rounded-tl-md bg-white border border-parkingrabbit-border px-4 py-3">
            <p className="text-[12.5px] font-bold text-parkingrabbit-navy">
              ParkingRabbit
            </p>
            <p className="text-[12.5px] text-parkingrabbit-navy/90 mt-0.5 leading-snug">
        ...
        <p className="text-[11px] text-parkingrabbit-muted text-center">
          ...
          <a
            ...
            className="font-semibold text-parkingrabbit-primary hover:underline"
          >
            {SUPPORT_EMAIL}
          </a>
        </p>
