...
evidenceBar: "medium"
quirks: |
  - Strong CCTV enforcement — VRM misread cases are common, always check the council's photo against the actual plate.
  - Discount window is 14 days.
  - Operates virtual permits — check the live DB.
  - Lambeth is generally responsive to first-time appellants who provide clear evidence.
---
