...
- [Monitoring appeals](monitoring-appeals.md) — the appeals dashboard, status flows, manual overrides.

For now, see [architecture/knowledge-base.md](../architecture/knowledge-base.md) for the schema the admin UI will manage.
