...
Visual references for the ParkingRabbit brand and app. The first mockup is the app's in-product home screen; the second is the public marketing homepage. Both share a shield logo, navy/purple brand language, and a four-step "Your Progress" timeline.

---

## 1. Marketing homepage (received 2026-05-19, evening)

The public-facing **homepage** at `parkingrabbit.com` (or chosen domain). What a first-time visitor sees before they sign in or download.

<figure markdown>
  ![ParkingRabbit marketing homepage mockup](../assets/mockup-homepage.jpeg){ width="720" }
  <figcaption>ParkingRabbit — public marketing homepage, v0.1 mockup.</figcaption>
</figure>
...
|---|---|---|
| Top nav (left) | Shield-P logo + wordmark **ParkingRabbit** + tagline *"We fight your parking tickets"* | Identity block. |
| Top nav (centre) | How it works · Why ParkingRabbit? · Success stories · Pricing · FAQ | Five primary nav items. |
...
| Hero body | *"ParkingRabbit makes it easy to appeal parking tickets in the UK. We guide you step-by-step and create powerful appeals tailored to your case."* | One paragraph. |
...
| Hero visual | Phone mockup overlaid on a real PCN-on-windscreen photo; phone shows "Hello, Alex 👋", an "appeal in progress" purple card, a 4-step progress timeline, and "Need help?" support card. Floating shield badge: *"Thousands of UK drivers trust ParkingRabbit"*. | Mirrors the in-app home screen (mockup #2 below). |
...
<figure markdown>
  ![ParkingRabbit in-app home screen mockup](../assets/mockup-home.jpeg){ width="320" }
  <figcaption>ParkingRabbit — in-app home screen, v0.1 mockup.</figcaption>
</figure>
...
|---|---|---|
| Top bar | Shield-P logo · "Park Appeal UK" (legacy long-form, now superseded by ParkingRabbit) · "Challenge your parking ticket in minutes" · `UK` location pill | The `UK` pill reads `London` for the locked v0.1 scope. |
